namespace SteamAccountSwitcher
{
    partial class Settings
    {
        ...
        private void InitializeComponent()
        {
			...
			this.launchOnStartup = new System.Windows.Forms.CheckBox();
			...
			this.settingsPanel.Size = new System.Drawing.Size(339, 178);
			this.settingsPanel.TabIndex = 1;
			// 
			// userPanel
			// 
			this.userPanel.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.userPanel.Controls.Add(this.launchOnStartup);
			...
			this.userPanel.Size = new System.Drawing.Size(205, 178);
			this.userPanel.TabIndex = 4;
			// 
			// launchOnStartup
			// 
			this.launchOnStartup.AutoSize = true;
			this.launchOnStartup.Location = new System.Drawing.Point(10, 150);
			this.launchOnStartup.Name = "launchOnStartup";
			this.launchOnStartup.Size = new System.Drawing.Size(112, 17);
			this.launchOnStartup.TabIndex = 7;
			this.launchOnStartup.Text = "Launch on startup";
			this.toolTip.SetToolTip(this.launchOnStartup, "Launch the program on Windows startup.");
			this.launchOnStartup.UseVisualStyleBackColor = true;
			// 
			// startMinimisedCheck
			// 
			...
			this.devPanel.Size = new System.Drawing.Size(134, 178);
		...
		private System.Windows.Forms.CheckBox launchOnStartup;
	}
}